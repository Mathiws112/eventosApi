...
const bodyParser = require('body-parser'); // Importa la librería bodyparser para parsear datos del cuerpo de las peticiones HTTP
...
class Server{
    ...
    constructor(){
        ...
        this.eventosPath = '/api/eventos'; // Define la ruta base para las operaciones relacionadas con eventos
    ...
    routes() {
        ...
        this.app.use(this.eventosPath, require('../routes/eventos')); // Ruta para las operaciones relacionadas con eventos
